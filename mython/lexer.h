...
public:
    ...
    const T& Expect() const
    {
        ...
        throw LexerError("Wrong expect"s);
    }
    ...
    {
        using namespace std::literals;
        if (!current_token_.Is<T>() || current_token_ != Token(T{ value }))
        {
            throw LexerError("Wrong expect"s);
        }
    }
    ...
    void ExpectNext(const U& value)
    {
        ...
        if (!NextToken().Is<T>() || current_token_ != Token(T{ value }))
        {
            throw LexerError("Wrong expect"s);
        }
    }
